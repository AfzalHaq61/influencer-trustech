...
class FreelancerOrder extends Model
{
    ...
    protected $guarded = [];
    protected $table = 'freelancer_orders';
    ...
    {
        return $this->belongsTo(FreelancerService::class, 'service_id');
    }
    ...
    {
        return $this->hasMany(FreelancerOrderConversation::class, 'order_id')->latest();
    }
