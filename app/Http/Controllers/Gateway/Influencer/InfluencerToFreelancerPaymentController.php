...
namespace App\Http\Controllers\Gateway\Influencer;
...
class InfluencerToFreelancerPaymentController extends Controller
{
    ...
    public function payment(){
        ...
        if (!$paymentData) {
            ...
            return redirect()->route('influencer.home')->withNotify($notify);
        }
        $amount = $paymentData['amount'];
        return view($this->activeTemplate . 'influencer.payment.deposit', compact('userType','gatewayCurrency', 'pageTitle', 'amount'));
    }
    ...
    public function deposit()
    {
        ...
        $pageTitle = 'Deposit Methods';
        return view($this->activeTemplate . 'influencer.payment.deposit', compact('gatewayCurrency', 'pageTitle'));
    }
    ...
    public function depositInsert(Request $request){
        ...
        return to_route('influencer.influencer.deposit.confirm');
    }
    ...
    public function appDepositConfirm($hash)
    {
        ...
        auth()->login($user);
        session()->put('Track', $data->trx);
        return to_route('influencer.deposit.confirm');
    }
    ...
    public function depositConfirm(){
        ...
        if ($deposit->method_code >= 1000) {
            return to_route('influencer.deposit.manual.confirm');
        }
        ...
        $admin_transaction->influencer_id     = $influencer_id;
    ...
    public static function userDataUpdate($deposit, $isManual = null)
    {
        if ($deposit->status == 0 || $deposit->status == 2) {
            ...
            $influencer = Influencer::find($deposit->influencer_id);
            // $influencer->balance += $deposit->amount;
            // $influencer->save();
            ...
            $transaction->influencer_id     = $deposit->influencer_id;
            ...
            if ($deposit->hiring_id) {
                ...
                $adminNotification->title           = 'A new hiring requested by ' . $influencer->username;
                ...
                $adminNotification                  = new AdminNotification();
                $adminNotification->influencer_id   = $influencer->id;
                $adminNotification->title           = 'A new order placed by ' . $influencer->username;
                ...
                notify($influencer, $isManual ? 'DEPOSIT_APPROVE' : 'DEPOSIT_COMPLETE', [
    ...
    public function manualDepositConfirm(){
        ...
        if ($data->method_code > 999) {
            ...
            return view($this->activeTemplate . 'influencer.payment.manual', compact('data', 'pageTitle', 'method', 'gateway'));
        }
        abort(404);
    }
    ...
    public function manualDepositUpdate(Request $request)
    {
        ...
        return to_route('influencer.deposit.history')->withNotify($notify);
    }
}
