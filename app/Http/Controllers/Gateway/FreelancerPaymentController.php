...
class FreelancerPaymentController extends Controller
{
    ...
    public function payment()
    {
        ...
        return view($this->activeTemplate . 'user.payment.freelancer_deposit', compact('gatewayCurrency', 'pageTitle', 'amount'));
    }
    ...
    public function deposit()
    {
        ...
        $pageTitle = 'Deposit Methods';
        return view($this->activeTemplate . 'user.payment.freelancer_deposit', compact('gatewayCurrency', 'pageTitle'));
    }
    ...
    public function depositInsert(Request $request)
    {
        ...
        if ($paymentData) {
            ...
            if ($column == 'hiring_id') {
                ...
                $order = FreelancerOrder::findOrFail($value);
        ...
        return to_route('user.freelancer.deposit.confirm');
    }
    ...
    public function depositConfirm()
    {
        ...
        if ($deposit->method_code >= 1000) {
            return to_route('user.freelancer.deposit.manual.confirm');
        }
        ...
        $admin_transaction->user_id           = $user_id;
    ...
    public static function userDataUpdate($deposit, $isManual = null)
    {
        if ($deposit->status == 0 || $deposit->status == 2) {
            ...
            if ($deposit->hiring_id) {
                ...
                $order = FreelancerOrder::find($deposit->order_id);
