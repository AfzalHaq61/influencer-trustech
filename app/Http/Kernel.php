...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'freelancer_kyc' => \App\Http\Middleware\FreelancerKycMiddleware::class,
        ...
        'freelancer' => \App\Http\Middleware\RedirectIfNotFreelancer::class,
        'freelancer.check' => \App\Http\Middleware\FreelancerCheck::class,
        'freelancer.registration.complete' => \App\Http\Middleware\FreelancerRegistrationStep::class,
        'freelancer.guest' => \App\Http\Middleware\RedirectIfFreelancer::class,
