...
Route::post('influencer/stripe-js', 'Influencer\StripeJs\ProcessController@ipn')->name('influencer.StripeJs');
Route::post('freelancer/stripe-js', 'Freelancer\StripeJs\ProcessController@ipn')->name('freelancer.StripeJs');
