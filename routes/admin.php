...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageInfluencersController')->name('influencers.')->prefix('influencers')->group(function () {
     ...
     // Freelancer Manager
     Route::controller('ManageFreelancersController')->name('freelancers.')->prefix('freelancers')->group(function () {
        Route::get('/', 'allFreelancers')->name('all');
        Route::get('active', 'activeFreelancers')->name('active');
        Route::get('banned', 'bannedFreelancers')->name('banned');
        Route::get('email-verified', 'emailVerifiedFreelancers')->name('email.verified');
        Route::get('email-unverified', 'emailUnverifiedFreelancers')->name('email.unverified');
        Route::get('mobile-unverified', 'mobileUnverifiedFreelancers')->name('mobile.unverified');
        Route::get('kyc-unverified', 'kycUnverifiedFreelancers')->name('kyc.unverified');
        Route::get('kyc-pending', 'kycPendingFreelancers')->name('kyc.pending');
        Route::get('mobile-verified', 'mobileVerifiedFreelancers')->name('mobile.verified');
        Route::get('with-balance', 'FreelancersWithBalance')->name('with.balance');
    ...
    Route::controller('CategoryController')->name('category.')->prefix('categories')->group(function () {
        ...
        Route::get('{belongs_to}', 'filterCategory')->name('filter');
        Route::post('store/{id?}', 'store')->name('store');
    });

    // Job Category
    Route::controller('JobCategoryController')->name('jobcategory.')->prefix('job-categories')->group(function () {
        Route::get('', 'index')->name('index');
        Route::get('{belongs_to}', 'filterCategory')->name('filter');
        Route::post('store/{id?}', 'store')->name('store');
    ...
    // Job Subcategory
    Route::controller('JobSubCategoryController')->name('jobsubcategory.')->prefix('job-subcategories')->group(function () {
        Route::get('', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id?}', 'changeStatus')->name('status');
    });
    ...
    // Job Skills
    Route::controller('JobSkillController')->name('jobskill.')->prefix('job-skills')->group(function () {
        Route::get('', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id?}', 'changeStatus')->name('status');
    });

    // Manage Influencer Service
    ...
    // Manage Freelancer Service
    Route::controller('ManageFreelancerServiceController')->name('freelancer.service.')->prefix('freelancer/services')->group(function () {
        Route::get('/index', 'index')->name('index');
        Route::get('/pending', 'pending')->name('pending');
        Route::get('/approved', 'approved')->name('approved');
        Route::get('/rejected', 'rejected')->name('rejected');
    ...
    // Manage Jobs
    Route::controller('ManageJobController')->name('job.')->prefix('job')->group(function () {
        Route::get('pending', 'pending')->name('pending');
        Route::get('approved', 'approved')->name('approved');
    ...
    Route::controller('NewsLetterController')->name('news-letter.')->prefix('news-letter')->group(function () {
        //influencer
        Route::get('influencer', 'influencer')->name('influencer');
        Route::get('filter/influencer', 'filterInfluencer')->name('filter.influencer');
        Route::post('influencer/send-mail', 'influencerSendMail')->name('influencer.send-mail');

        //Freelancer
        Route::get('freelancer', 'freelancer')->name('freelancer');
        Route::get('filter/freelancer', 'filterFreelancer')->name('filter.freelancer');
        Route::post('freelancer/send-mail', 'freelancerSendMail')->name('freelancer.send-mail');

        //Client
        Route::get('client', 'client')->name('client');
        Route::post('client/send-mail', 'clientSendMail')->name('client.send-mail');

        //All Users
        Route::get('all-users', 'allUsers')->name('all-users');
        Route::post('all-users/send-mail', 'allUsersSendMail')->name('all-users.send-mail');
    });
    ...
    Route::controller('FreelancerReportController')->name('freelancer.')->prefix('freelancer')->group(function () {
        Route::get('report/transaction', 'transaction')->name('report.transaction');
        Route::get('report/login/history', 'loginHistory')->name('report.login.history');
        Route::get('report/login/ipHistory/{ip}', 'loginIpHistory')->name('report.login.ipHistory');
        Route::get('report/notification/history', 'notificationHistory')->name('report.notification.history');
    ...
    Route::controller('SupportTicketController')->group(function () {
        ...
        // freelancer
        Route::get('freelancer/tickets', 'freelancerTickets')->name('freelancer.ticket');
        Route::get('freelancer/tickets/pending', 'freelancerPendingTicket')->name('freelancer.ticket.pending');
        Route::get('freelancer/tickets/closed', 'freelancerClosedTicket')->name('freelancer.ticket.closed');
        Route::get('freelancer/tickets/answered', 'freelancerAnsweredTicket')->name('freelancer.ticket.answered');
        Route::get('freelancer/tickets/view/{id}', 'ticketReply')->name('freelancer.ticket.view');
    });
    ...
    Route::controller('KycController')->group(function () {
        ...
        Route::post('influencer/kyc-setting', 'influencerSettingUpdate')->name('influencer.kyc.setting');
    });
