...
Route::middleware('influencer')->name('influencer.')->group(function () {
    ...
    Route::middleware(['influencer.check'])->group(function () {
        ...
        //Influencer to client payment
        Route::middleware('influencer.registration.complete')->controller('Gateway\Influencer\InfluencerToClientPaymentController')->group(function () {
            Route::any('payment', 'payment')->name('client.payment');
            Route::any('deposit', 'deposit')->name('deposit');
            Route::post('deposit/insert', 'depositInsert')->name('user.deposit.insert');
        ...
        //Influencer to influencer payment 
        Route::middleware('influencer.registration.complete')->controller('Gateway\Influencer\InfluencerToInfluencerPaymentController')->group(function () {
            Route::any('payment', 'payment')->name('influencer.payment');
            Route::any('deposit', 'deposit')->name('deposit');
        ...
        //Influencer to Freelancer payment 
        Route::middleware('influencer.registration.complete')->controller('Gateway\Influencer\InfluencerToInfluencerPaymentController')->group(function () {
            Route::any('payment', 'payment')->name('freelancer.payment');
            Route::any('deposit', 'deposit')->name('deposit');
