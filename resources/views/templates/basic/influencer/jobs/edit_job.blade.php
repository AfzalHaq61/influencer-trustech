...
@section('content')
    <div class="card custom--card">
        <div class="card-body">
            <form action="{{ route('influencer.jobs.insert',$job->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form--control subcategory" name="sub_category_id" id="sub_category_id" required>
