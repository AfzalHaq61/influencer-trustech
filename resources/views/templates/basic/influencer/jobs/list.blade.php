                ...
                <tr>
                    ...
                    <td data-label="@lang('Action')">
                        <div class="d-flex flex-wrap gap-2 justify-content-end">
                            @if($job->status == 0 )
                                <a href="{{ route('influencer.jobs.edit', $job->id) }}" class="btn btn--sm btn--outline-base @if ($job->status == 2) disabled @endif">
                                    <i class="la la-edit"></i> @lang('Edit')
                                </a>
                            @endif
                            
                            @if($job->status == 2 || $job->status == 3 || $job->status == 4 || $job->status == 7)
                                <a href="{{ route('influencer.jobs.detail', $job->id) }}" class="btn btn--sm btn--outline-base">
