                ...
                @forelse($job_applications as $applicant)
                    ...
                    <tr>
                        ...
                        <td data-label="@lang('Action')">
                            ...
                            <div class="d-flex flex-wrap gap-2 justify-content-end">
                                <a href="{{ route('influencer.jobs.assign.job', ['user', $applicant->user_id, $applicant->id]) }}" class="btn btn--sm btn--outline-base @if ($applicant->status == 2) disabled @endif">
                    ...
                    <tr>
                        ...
                        <td data-label="@lang('Action')">
                            ...
                            @else
                            <div class="d-flex flex-wrap gap-2 justify-content-end">
                                <a href="{{ route('influencer.jobs.assign.job', ['influencer', $applicant->influencer_id, $applicant->id]) }}" class="btn btn--sm btn--outline-base @if($applicant->status == 2) disabled @endif">
                                    <i class="la la-check"></i> @lang('Approve')
                                </a>
                                <a href=" " class="btn btn--sm btn--outline-danger @if ($applicant->status == 2) disabled @endif">
                                    <i class="las la-times"></i> @lang('Reject')
                    ...
                    <tr>
                        ...
                        <td data-label="@lang('Action')">
                            ...
                            @else
                            <div class="d-flex flex-wrap gap-2 justify-content-end">
                                <a href="{{ route('influencer.jobs.assign.job', ['freelancer', $applicant->freelancer_id, $applicant->id]) }}" class="btn btn--sm btn--outline-base @if ($applicant->status == 2) disabled @endif">
                                    <i class="la la-check"></i> @lang('Approve')
                                </a>
                                <a href=" " class="btn btn--sm btn--outline-danger @if ($applicant->status == 2) disabled @endif">
                                    <i class="las la-times"></i> @lang('Reject')
