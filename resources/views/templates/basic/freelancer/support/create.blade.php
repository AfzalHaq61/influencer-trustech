...
@section('content')
    <div class="card custom--card">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
            ...
            <a href="{{ route('freelancer.ticket') }}" class="btn btn--outline-custom btn--sm">@lang('My Tickets')</a>
        </div>
        <div class="card-body">
            <form class="row gy-3" action="{{ route('freelancer.ticket.store') }}" method="post" enctype="multipart/form-data" onsubmit="return submitUserForm();">
                @csrf
