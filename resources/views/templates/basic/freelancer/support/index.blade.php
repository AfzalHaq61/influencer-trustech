    ...
    <table class="table table--responsive--lg">
        ...
        <tbody>
            @forelse($supports as $key => $support)
                <tr>
                    <td data-label="@lang('Subject')"> <a href="{{ route('freelancer.ticket.view', $support->ticket) }}"
                    ...
                    <td data-label="@lang('Action')">
                        <a href="{{ route('freelancer.ticket.view', $support->ticket) }}" class="btn btn--sm btn--outline-base">
