        ...
        <div class="card custom--card mt-4">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <button type="button" class="btn btn--sm btn--outline-danger confirmationBtn" data-action="{{ route('freelancer.service.order.cancel.status', $order->id) }}" data-question="@lang('Are you sure to cancel this order?')" data-btn_class="btn btn--base btn--md">
                        <i class="las la-times"></i> @lang('Cancel')
                    </button>

                    <button type="button" class="btn btn--sm btn--outline-success confirmationBtn" data-action="{{ route('freelancer.service.order.accept.status', $order->id) }}" data-question="@lang('Are you sure to accept this order request?')" data-btn_class="btn btn--base btn--md">
                    ...
                    @if ($order->status == 2)
                    <button type="button" class="btn btn--sm btn--outline-primary confirmationBtn" data-action="{{ route('freelancer.service.order.jobDone.status', $order->id) }}" data-question="@lang('Are you sure that the job is done successfully?')" data-btn_class="btn btn--base btn--md">
