    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card custom--card">
                <div class="card-body">
                    <form action="{{ route('freelancer.'.$userType.'.deposit.insert') }}" method="post" class="row gy-2">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" name="amount" class="form-control form--control" value="{{ old('amount', @$amount) }}" autocomplete="off" required @isset($amount) readonly @endisset>
