                                    ...
                                    <div class="item-category-area border-bottom">
                                        <div class="category-slider mb-4">
                                            <div class="swiper-wrapper">
                                                @foreach($category->JobSubCategories as $subcategory)
                                                    <div class="swiper-slide">
                                                        <div class="category-item-box">
                                                            <a href="{{route('by.subcategory', [slug($subcategory->name), $subcategory->id])}}">
                                                                <img src="{{ getImage(getFilePath('category').'/'.$subcategory->image, getFileSize('category')) }}" alt="@lang('Subcategory Image')">
