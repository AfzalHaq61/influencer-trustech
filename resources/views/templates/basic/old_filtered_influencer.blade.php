        ...
        <div class="col-md-6 col-lg-3 col-xl-3 col-sm-9 col-xs-10">
            <div class="influencer-item">
                ...
                <div class="influencer-thumb">
                    <img src="{{ url('/') }}/core/public/sample/{{$influencer->username}}/photos/{{$influencer->image}}" alt="cover">
                ...
                <div class="influencer-item__content">
                    ...
                    <ul class="social-links d-flex justify-content-center flex-wrap">
                        ...
                        <li><a href="{{ $social->url }}" data-bs-toggle="tooltip" data-placement="top" title="{{ __($social->followers) }}" target="_blank">@php echo $social->social_icon @endphp</a></li>
                        @endforeach
                    </ul>
                </div>
                @php
                ...
                <div class="influencer-item__content">
                    ...
                    <ul class="social-links d-flex justify-content-center flex-wrap">
                        @foreach ($influencer->socialLink as $social)
                            ...
                            @endphp
                            <li><a href="https://{{ $social->url }}" data-bs-toggle="tooltip" data-placement="top" title="{{ __($social->followers) }}" target="_blank">@php echo $social->social_icon; echo $count  @endphp</a></li>
                        @endforeach
                    </ul>
                </div>
                @php
