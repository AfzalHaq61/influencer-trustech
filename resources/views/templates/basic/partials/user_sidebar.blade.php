<div class="col-xl-3">
    <div class="dash-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ menuActive('user.order*',2) }}">
                <a href="javascript:void(0)"><i class="las la-wallet"></i> @lang('Orders')</a>

                <ul class="sidebar-submenu  }}">
                    <li><a href="{{ route('user.order.all') }}" class="{{ menuActive('user.order.all') }}"><i class="las la-dot-circle"></i> @lang('Influencers')</a></li>
                    <li><a href="{{ route('user.order.freelancer.all') }}" class="{{ menuActive('user.order.freelancer.all') }}"><i class="las la-dot-circle"></i> @lang('Freelancers')</a></li>
                </ul>
            </li>

            <li class="{{ menuActive('user.jobs.*',2) }}">
                <a href="javascript:void(0)"><i class="las la-user"></i> @lang('Jobs') </a>
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('user.jobs.create') }}" class="{{ menuActive('user.jobs.create') }}"><i class="las la-plus"></i> @lang('Create job')</a>
                    </li>
                    <li>
                        <a href="{{ route('user.jobs.all') }}" class="{{ menuActive('user.jobs.all') }}"><i class="la la-dot-circle"></i> @lang('All Jobs')</a>
                    </li>
                    <li>
                        <a href="{{ route('user.jobs.applications') }}" class="{{ menuActive('user.jobs.applications') }}"><i class="la la-dot-circle"></i> @lang('Job Applications')</a>
                    </li>
                    <li>
                        <a href="{{ route('user.jobs.assign-to-you') }}" class="{{ menuActive('user.jobs.assign-to-you') }}"><i class="la la-dot-circle"></i> @lang('Assign to you')</a>
                    </li>
                </ul>
            </li>
