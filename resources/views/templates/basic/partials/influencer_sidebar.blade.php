<div class="col-xl-3">
    <div class="dash-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ menuActive('influencer.jobs.*',2) }}">
                <a href="javascript:void(0)"><i class="las la-user"></i> @lang('Jobs') </a>
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('influencer.jobs.create') }}" class="{{ menuActive('influencer.jobs.create') }}"><i class="las la-plus"></i> @lang('Create job')</a>
                    </li>

                    <li>
                        <a href="{{ route('influencer.jobs.all') }}" class="{{ menuActive('influencer.jobs.all') }}"><i class="la la-dot-circle"></i> @lang('All Jobs')</a>
                    </li>

                    <li>
                        <a href="{{ route('influencer.jobs.applications') }}" class="{{ menuActive('influencer.jobs.applications') }}"><i class="la la-dot-circle"></i> @lang('Job Applications')</a>
                    </li>
                    <li>
                        <a href="{{ route('influencer.jobs.assign-to-you') }}" class="{{ menuActive('influencer.jobs.assign-to-you') }}"><i class="la la-dot-circle"></i> @lang('Assign to you')</a>
                    </li>
                </ul>
            </li>
