...
$condition = request()->routeIs('user.*') || request()->routeIs('influencer.*') || request()->routeIs('freelancer.*') || request()->routeIs('ticket*');
@endphp
        ...
        <div class="container">
            <div class="header-bottom-area align-items-center">
                ...
                <ul class="menu">
                    ...
                    <li>
                        <a href="{{ route('jobs') }}" class="{{ menuActive('jobs') }}">@lang('Jobs')</a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('freelancers') }}" class="{{ menuActive('freelancers') }}">@lang('Freelancers')</a>
                    </li>
                ...
                <div class="header-trigger-wrapper d-flex align-items-center">
                    <div class="button-wrapper d-flex align-items-center flex-wrap" style="gap:8px 15px">
                        @if (!(auth()->id() || authInfluencerId() ||  authFreelancerId()))
                        ...
                        @auth('freelancer')
                            <ul class="d-flex align-items-center flex-wrap">
                                <li class="me-0">
                                    <a href="{{ route('freelancer.home') }}" class="login-btn btn--md btn btn--outline-base d-none d-sm-grid text-white">@lang('Dashboard')</a>
                                </li>
                            </ul>
                        @endauth
