    ...
    <section class="pt-80 pb-80">
        <div class="container">
            <div class="card custom--card">
                ...
                <div class="card-body">
                    <form action="{{ route('user.order.freelancer.confirm', [$freelancer->id, $service->id]) }}" method="POST">
                        @csrf
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-label">@lang('freelancer')</label>
                                    <input type="text" class="form-control form--control" value="{{ __($freelancer->fullname) }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" step="any" class="form-control form--control" name="price" value="{{ showAmount($service->price) }}" {{$service->price != 0 ?'disabled':''}}>
