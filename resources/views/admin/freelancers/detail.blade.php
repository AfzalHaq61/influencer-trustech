    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($freelancer->balance) }}</h3>
                            <p class="text-white">@lang('Balance')</p>
                        </div>
                        <a href="{{ route('admin.report.transaction') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <a href="{{ route('admin.service.index') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <a href="{{ route('admin.withdraw.log') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--orange">
                        ...
                        <a href="{{ route('admin.order.pending') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--info">
                        ...
                        <a href="{{ route('admin.order.inprogress') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--18">
                        ...
                        <a href="{{ route('admin.order.jobDone') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--green">
                        ...
                        <a href="{{ route('admin.order.completed') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--dark">
                        ...
                        <a href="{{ route('admin.order.reported') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--14">
                        ...
                        <a href="{{ route('admin.order.cancelled') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--warning">
                        ...
                        <a href="{{ route('admin.hiring.pending') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--blue">
                        ...
                        <a href="{{ route('admin.hiring.inprogress') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--indigo">
                        ...
                        <a href="{{ route('admin.hiring.jobDone') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--success">
                        ...
                        <a href="{{ route('admin.hiring.completed') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--black">
                        ...
                        <a href="{{ route('admin.hiring.reported') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--danger">
                        ...
                        <a href="{{ route('admin.hiring.cancelled') }}?search={{ $freelancer->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <a href="{{route('admin.report.login.history')}}?search={{ $freelancer->username }}" class="btn btn--primary btn--shadow w-100 btn-lg">
                        <i class="las la-list-alt"></i>@lang('Logins')
                    </a>
                </div>

                <div class="flex-fill">
                    <a href="{{ route('admin.freelancers.notification.log',$freelancer->id) }}" class="btn btn--secondary btn--shadow w-100 btn-lg">
                        <i class="las la-bell"></i>@lang('Notifications')
                    </a>
                </div>

                <div class="flex-fill">
                    <a href="{{route('admin.freelancers.login',$freelancer->id)}}" target="_blank" class="btn btn--primary btn--gradi btn--shadow w-100 btn-lg">
                        <i class="las la-sign-in-alt"></i>@lang('Login as Freelancer')
                    </a>
                </div>

                @if($freelancer->kyc_data)
                <div class="flex-fill">
                    <a href="{{ route('admin.freelancers.kyc.details', $freelancer->id) }}" target="_blank" class="btn btn--dark btn--shadow w-100 btn-lg">
                ...
                <div class="flex-fill">
                    ...
                    <button type="button" class="btn btn--warning btn--gradi btn--shadow w-100 btn-lg userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal">
                        <i class="las la-ban"></i>@lang('Ban Freelancer')
                    </button>
                    @else
                    <button type="button" class="btn btn--success btn--gradi btn--shadow w-100 btn-lg userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal">
                        <i class="las la-undo"></i>@lang('Unban Freelancer')
                    </button>
                    @endif
                </div>
            </div>
            ...
            <div class="card mt-30">
                <div class="card-header">
                    <h5 class="card-title mb-0">@lang('Information of') {{$freelancer->fullname}}</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="firstname" required value="{{$freelancer->firstname}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lastname" required value="{{$freelancer->lastname}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" name="email" value="{{$freelancer->email}}" required>
                                </div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="address" value="{{@$freelancer->address->address}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="city" value="{{@$freelancer->address->city}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="state" value="{{@$freelancer->address->state}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="zip" value="{{@$freelancer->address->zip}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group  col-xl-3 col-md-6 col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       ...
                                       @if($freelancer->ev) checked @endif>
                            ...
                            <div class="form-group  col-xl-3 col-md-6 col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       ...
                                       @if($freelancer->sv) checked @endif>

                            </div>
                            <div class="form-group col-xl-3 col-md- col-12">
                                <label>@lang('2FA Verification') </label>
                                <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disable')" name="ts" @if($freelancer->ts) checked @endif>
                            </div>
                            <div class="form-group col-xl-3 col-md- col-12">
                                <label>@lang('KYC') </label>
                                <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="kv" @if($freelancer->kv) checked @endif>
                            </div>
                        </div>
    ...
    <div id="addSubModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.freelancers.add.sub.balance',$freelancer->id)}}" method="POST">
                    @csrf
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        @if($freelancer->status == 1)
                        <span>@lang('Ban Freelancer')</span>
                        @else
                        <span>@lang('Unban Freelancer')</span>
                        @endif
                    </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                ...
                <form action="{{route('admin.freelancers.status',$freelancer->id)}}" method="POST">
                    @csrf
                    <div class="modal-body">
                        @if($freelancer->status == 1)
                        <h6 class="mb-2">@lang('If you ban this freelancer he/she won\'t able to access his/her dashboard.')</h6>
                        <div class="form-group">
                        ...
                        <p>{{ $freelancer->ban_reason }}</p>
                        <h4 class="text-center mt-3">@lang('Are you sure to unban this freelancer?')</h4>
                        @endif
                    </div>
                    <div class="modal-footer">
                        @if($freelancer->status == 1)
...
<script>
    ...
    "use strict"
        ...
        $('select[name=country]').val('{{@$freelancer->country_code}}');
        let dialCode        = $('select[name=country] :selected').data('mobile_code');
        let mobileNumber    = `{{ $freelancer->mobile }}`;
