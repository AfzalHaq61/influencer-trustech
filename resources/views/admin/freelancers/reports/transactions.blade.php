                            ...
                            @forelse($transactions as $trx)
                                <tr>
                                    <td data-label="@lang('User')">
                                        <span class="fw-bold">{{ @$trx->freelancer->fullname }}</span>
                                        <br>
                                        <span class="small"> <a href="{{ appendQuery('search',@$trx->freelancer->username) }}"><span>@</span>{{ @$trx->freelancer->username }}</a> </span>
                                    </td>
