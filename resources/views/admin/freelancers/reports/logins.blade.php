                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($loginLogs as $log)
                                ...
                                <td data-label="@lang('User')">
                                        ...
                                        <br>
                                        <span class="small"> <a href="{{ route('admin.freelancers.detail', $log->freelancer_id) }}"><span>@</span>{{ @$log->freelancer->username }}</a> </span>
                                    ...
                                    <td data-label="@lang('IP')">
                                        <span class="fw-bold">
                                        <a href="{{route('admin.freelancer.report.login.ipHistory',[$log->user_ip])}}">{{ $log->user_ip }}</a>
                                        </span>
                                    </td>
