                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        <td data-label="@lang('User')">
                                            @if($log->freelancer)
                                            <span class="fw-bold">{{ $log->freelancer->fullname }}</span>
                                                <br>
                                            <span class="small">
                                                <a href="{{ route('admin.freelancers.detail', $log->freelancer_id) }}"><span>@</span>{{ $log->freelancer->username }}</a>
                                            </span>
                                            @else
...
@push('breadcrumb-plugins')
    @if(@$freelancer)
        <a href="{{ route('admin.freelancers.notification.single',$freelancer->id) }}" class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
    @else
