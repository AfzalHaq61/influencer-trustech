                    ...
                    <div class="table-responsive--md table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Status')">
                                    @if ($category->belongs_to == 'influencer')
                                        <span class="text--small badge font-weight-normal badge--warning">@lang('Influencer')</span>
                                    @else
                                        <span class="text--small badge font-weight-normal badge--primary">@lang('Freelancer')</span>
                                    @endif
                                </td>
                                <td data-label="@lang('Action')">
                                    <button class="btn btn-sm btn-outline--primary editButton" data-id="{{ $category->id }}" data-name="{{ $category->name }}" data-belongs_to="{{ $category->belongs_to }}" data-status="{{ $category->status }}" data-image="{{ getImage(getFilePath('category').'/'.$category->image, getFileSize('category')) }}">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>@lang('Belongs To')</label>
                            <div class="col-sm-12">
                                <select class="form-control" name="belongs_to" required>
...
<script>
    (function($) {
            ...
            $('.editButton').on('click', function() {
                ...
                modal.find('[name=belongs_to]').val($(this).data('belongs_to'));
