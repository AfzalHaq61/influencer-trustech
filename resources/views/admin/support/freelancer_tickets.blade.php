                            ...
                            @forelse($items as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Submitted By')">
                                        ...
                                        @elseif($item->freelancer_id)
                                        <a href="{{ route('admin.freelancers.detail', $item->freelancer_id)}}"> {{@$item->freelancer->fullname}}</a>
                                        @else
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{ route('admin.freelancer.ticket.view', $item->id) }}" class="btn btn-sm btn-outline--primary ms-1">
