    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.freelancers*',3)}}">
                        <i class="menu-icon las la-user-friends"></i>
                        <span class="menu-title">@lang('Manage Freelancer')</span>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.freelancers*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.freelancers.active')}} ">
                                <a href="{{route('admin.freelancers.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Freelancers')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.freelancers.banned')}} ">
                                <a href="{{route('admin.freelancers.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Freelancers')</span>
                                    @if($bannedInfluencersCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$bannedInfluencersCount}}</span>
                                    @endif
                                </a>
                            ...
                            <li class="sidebar-menu-item  {{menuActive('admin.freelancers.email.unverified')}}">
                                <a href="{{route('admin.freelancers.email.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email Unverified')</span>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.freelancers.mobile.unverified')}}">
                                <a href="{{route('admin.freelancers.mobile.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Mobile Unverified')</span>
                                    @if($mobileUnverifiedInfluencersCount)
                                        <span
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.freelancers.kyc.unverified')}}">
                                <a href="{{route('admin.freelancers.kyc.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('KYC Unverified')</span>
                                    @if($kycUnverifiedInfluencersCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$kycUnverifiedInfluencersCount}}</span>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.freelancers.kyc.pending')}}">
                                <a href="{{route('admin.freelancers.kyc.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('KYC Pending')</span>
                                    @if($kycPendingInfluencersCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$kycPendingInfluencersCount}}</span>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.freelancers.with.balance')}}">
                                <a href="{{route('admin.freelancers.with.balance')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('With Balance')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.freelancers.all')}} ">
                                <a href="{{route('admin.freelancers.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Freelancers')</span>
                                </a>
                            </li>


                            <li class="sidebar-menu-item {{menuActive('admin.freelancers.notification.all')}}">
                                <a href="{{route('admin.freelancers.notification.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Notification to All')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.jobcategory.*')}}">
                    <a href="{{route('admin.jobcategory.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.jobcategory.index') }}">
                       <i class="menu-icon las la-bars"></i>
                        <span class="menu-title">@lang('Job Categories') </span>
                    </a>
                </li>

                <li class="sidebar-menu-item  {{menuActive('admin.jobsubcategory.*')}}">
                    <a href="{{route('admin.jobsubcategory.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.jobsubcategory.index') }}">
                       <i class="menu-icon las la-bars"></i>
                        <span class="menu-title">@lang('Job Subcategories') </span>
                    </a>
                </li>

                <li class="sidebar-menu-item  {{menuActive('admin.jobskill.*')}}">
                    <a href="{{route('admin.jobskill.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.jobskill.index') }}">
                       <i class="menu-icon las la-bars"></i>
                        <span class="menu-title">@lang('Job Skills') </span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.news-letter*',3)}}">
                        <i class="menu-icon las la-envelope"></i>
                        <span class="menu-title">@lang('News Letter')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.news-letter*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.news-letter.influencer')}} ">
                                <a href="{{route('admin.news-letter.influencer')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Infuencers')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.news-letter.freelancer')}} ">
                                <a href="{{route('admin.news-letter.freelancer')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Freelancers')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.news-letter.client')}}">
                                <a href="{{route('admin.news-letter.client')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Clients')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.news-letter.all-users')}}">
                                <a href="{{route('admin.news-letter.all-users')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.freelancer.service*',3)}}">
                        <i class="menu-icon las la-tasks"></i>
                        <span class="menu-title">@lang('Freelan Services')</span>

                        @if($freelancerPendingServiceCount > 0)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.freelancer.service*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.freelancer.service.index')}} ">
                                <a href="{{route('admin.freelancer.service.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Services')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.freelancer.service.pending')}} ">
                                <a href="{{route('admin.freelancer.service.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Services')</span>
                                    @if($freelancerPendingServiceCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$freelancerPendingServiceCount}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.freelancer.service.approved')}} ">
                                <a href="{{route('admin.freelancer.service.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Services')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.freelancer.service.rejected')}}">
                                <a href="{{route('admin.freelancer.service.rejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Services')</span>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.freelancer.ticket*',3)}}">
                        <i class="menu-icon la la-ticket"></i>
                        <span class="menu-title">@lang('Support Freelancer') </span>
                        @if(0 < $freelancerPendingTicketCount)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.freelancer.ticket*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.ticket.pending')}} ">
                                <a href="{{route('admin.freelancer.ticket.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Ticket')</span>
                                    @if($freelancerPendingTicketCount)
                                    <span
                                    class="menu-badge pill bg--danger ms-auto">{{$freelancerPendingTicketCount}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.freelancer.ticket.closed')}} ">
                                <a href="{{route('admin.freelancer.ticket.closed')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Closed Ticket')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.freelancer.ticket.answered')}} ">
                                <a href="{{route('admin.freelancer.ticket.answered')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Answered Ticket')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.freelancer.ticket')}} ">
                                <a href="{{route('admin.freelancer.ticket')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Ticket')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.freelancer.report*',3)}}">
                        <i class="menu-icon la la-list"></i>
                        <span class="menu-title">@lang('Freelancer Report') </span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.freelancer.report*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.freelancer.report.transaction','admin.freelancer.report.transaction.search'])}}">
                                <a href="{{route('admin.freelancer.report.transaction')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Transaction Log')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive(['admin.freelancer.report.login.history','admin.freelancer.report.login.ipHistory'])}}">
                                <a href="{{route('admin.freelancer.report.login.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Login History')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.freelancer.report.notification.history')}}">
                                <a href="{{route('admin.freelancer.report.notification.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Notification History')</span>
                                </a>
                            </li>
