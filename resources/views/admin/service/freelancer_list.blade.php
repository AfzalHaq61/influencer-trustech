                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Title')</th>
                                    <th>@lang('Order')</th>
                                    @if(request()->routeIs('admin.freelancer.service.index'))
                                    <th>@lang('Status')</th>
                                    @endif
                                    <th>@lang('Action')</th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td data-label="@lang('Freelancer')">
                                        <span class="fw-bold">{{@$service->freelancer->fullname}}</span>
                                        <br>
                                        <span class="small">
                                        <a href="{{ route('admin.freelancers.detail', @$service->freelancer->id) }}"><span>@</span>{{ @$service->freelancer->username }}</a>
                                        </span>
                                    </td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{ route('admin.freelancer.service.detail', $service->id) }}" class="btn btn-sm btn-outline--primary">
